...
_______,    KC_BTN2,    _______,    _______,    KC_BTN1,    KC_BTN1,    _______,                                        _______,    _______,    _______,    _______,    _______,    _______,    _______,
                        _______,    _______,    _______,    _______,    _______,    _______,                _______,    _______,    _______,    _______,    TO(_GAM),   _______
),
...
_______,    _______,    KC_LEFT,    KC_DOWN,    KC_RGHT,    _______,    _______,                                        _______,    KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   _______,    _______,
